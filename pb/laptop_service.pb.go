...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x25, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x74, 0x75, 0x74, 0x6f, 0x2e,
...
var file_laptop_service_proto_goTypes = []interface{}{
	...
	(*Laptop)(nil),               // 2: grpctuto.pcbook.Laptop
}
var file_laptop_service_proto_depIdxs = []int32{
	2, // 0: grpctuto.pcbook.CreateLaptopRequest.laptop:type_name -> grpctuto.pcbook.Laptop
	0, // 1: grpctuto.pcbook.LaptopService.CreateLaptop:input_type -> grpctuto.pcbook.CreateLaptopRequest
	1, // 2: grpctuto.pcbook.LaptopService.CreateLaptop:output_type -> grpctuto.pcbook.CreateLaptopResponse
...
// Reference imports to suppress in_error if they are not otherwise used.
